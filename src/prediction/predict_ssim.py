...
TEST_SOURCE_DIR = '../MRI/Test/source_b'
TEST_TARGET_DIR = '../MRI/Test/target'
CHECKPOINT_PATH = '../MRI/Checkpoints/Checkpoints_SSIM/final_model_source_b.pt'
PDF_PATH = 'comparison_results_b_ssim.pdf'
CSV_PATH = 'comparison_results_b_ssim.csv'
INPUT_SIZE = (256, 256)  
...
class WaCAEN(nn.Module):
    ...
    def forward(self, x):
        ...
        return self.sigmoid(reconstructed_image)
...
def process_images_and_generate_pdf(test_source_dir, test_target_dir, checkpoint_path, pdf_path, csv_path):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_csv', type=str, default=CSV_PATH,
                        help='Ruta de salida para el csv de resultados')
